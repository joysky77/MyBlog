...
layout: post
title: "通知日历同步软件介绍"
date: 2026-06-19 23:55:00 +0800
categories: 技术
tags: [Android, 日历, 通知, AI]
---

# 通知日历同步软件介绍

![应用图标]({{ "/assets/calsync-icon.webp" | relative_url }})
...
[![GitHub license](https://img.shields.io/github/license/stevezmtstudios/calsync?style=flat-square)](https://github.com/stevezmtstudios/calsync/blob/main/LICENSE)
...
## 软件简介
github地址在：[这里](https://github.com/joysky77/calsync)，是从https://github.com/SteveZMTstudios/calsync分叉。
...
详情请查看 [隐私政策](https://github.com/stevezmtstudios/calsync/blob/main/POLICY.md)。
...
本项目基于 GPL-3.0 License 开源。详情见 [LICENSE](https://github.com/stevezmtstudios/calsync/blob/main/LICENSE)。
